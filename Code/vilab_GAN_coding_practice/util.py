...
def save(ckpt_dir, net, optim, epoch):
    ...
    save_dic.update({'netG' : net["generator"].state_dict(), 'optimG' : optim["generator"].state_dict()})
    save_dic.update({'netD' : net["discriminator"].state_dict(), 'optimG' : optim["discriminator"].state_dict()})
...
def load(ckpt_dir, net, optim, index = -1):
   ...
   # print(dict_model)
    ...
    net["generator"].load_state_dict(dict_model['netG'])
    optim["generator"].load_state_dict(dict_model['optimG'])
    net["discriminator"].load_state_dict(dict_model['netD'])
