...
PATH = HOME_PATH/"vilab_SSL_coding_practice"
...
#1
parser.add_argument("--network", default="resnet18", type=str, dest="network")
...
parser.add_argument("--chpt_every", default=20, type=int, dest="chpt_every")
